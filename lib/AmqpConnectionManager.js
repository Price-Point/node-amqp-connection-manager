...
class AmqpConnectionManager extends _events.EventEmitter {
  ...
  _connect() {
    ...
    return Promise.resolve().then(() => {
      ...
      const connectionOptions = url.connectionOptions || this.connectionOptions; //const amqpUrl = urlUtils.parse(urlString);
      ...
      _winston.default.error(urlString);

      _winston.default.error(JSON.stringify(connectionOptions));

      return _amqplib.default.connect(urlString, connectionOptions).then(connection => {
